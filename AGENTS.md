...
- Dev server runs on `http://localhost:3000`. REST APIs live under `/api/projects`, `/api/projects/[id]`, `/api/projects/[id]/notes`, and `/api/jobs`; the dashboard reads through these.
