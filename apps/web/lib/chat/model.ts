...
- SEO / Search Console: for rankings, queries, CTR, index coverage, sitemaps, or content opportunities, call get_lane_search. Requires gscSiteUrl on the lane + Search Console API access on the service account. Prefer rising/declining queries, top pages, device/country splits, sitemap errors, and inspected coverageState/verdict; do not invent rankings or index status.
