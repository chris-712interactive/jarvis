...
- Inbound email → code: allowlisted senders on a lane trigger code jobs via ingest_emails / cron. When the Cloud Agent finishes, the job lands in Needs you. Resolving it emails the sender. Do not claim a reply was sent unless resolve_job / Approve reports emailReply.sent.
