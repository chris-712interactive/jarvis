...
- Inbound email: allowlisted senders are classified as code vs question vs ambiguous via ingest_emails / cron. Code → Cloud Agent PR → Needs you → Approve & reply. Question → draft reply in Needs you → Approve & reply. Ambiguous → triage in Needs you (Resolve clears without emailing). Do not claim a reply was sent unless resolve_job / Approve reports emailReply.sent.
